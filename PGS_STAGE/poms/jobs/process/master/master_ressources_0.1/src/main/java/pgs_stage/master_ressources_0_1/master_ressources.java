...
package pgs_stage.master_ressources_0_1;
...
/**
 * Job: master_ressources Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_ressources implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_ressources";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				master_ressources.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_ressources.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pgs_stage.dim_bulk_movement_0_1.DIM_BULK_MOVEMENT childJob_tRunJob_1 = new pgs_stage.dim_bulk_movement_0_1.DIM_BULK_MOVEMENT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		pgs_stage.dim_bulk_product_0_1.DIM_BULK_PRODUCT childJob_tRunJob_2 = new pgs_stage.dim_bulk_product_0_1.DIM_BULK_PRODUCT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pgs_stage.dim_container_0_1.DIM_CONTAINER childJob_tRunJob_3 = new pgs_stage.dim_container_0_1.DIM_CONTAINER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		pgs_stage.dim_compartment_0_1.DIM_COMPARTMENT childJob_tRunJob_4 = new pgs_stage.dim_compartment_0_1.DIM_COMPARTMENT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		pgs_stage.fact_resources_0_1.FACT_RESOURCES childJob_tRunJob_5 = new pgs_stage.fact_resources_0_1.FACT_RESOURCES();
	    // pass DataSources
 ...
 */
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ggEOVRzAjZfQiDOvFvY055If84as6aDsa78h5oSenf6TQ3cIGDnbNt/YTT1xUOY=");
 ...
 */
    ...
    public static void main(String[] args){
        final master_ressources master_ressourcesClass = new master_ressources();

        int exitCode = master_ressourcesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_ressources.class.getClassLoader().getResourceAsStream("pgs_stage/master_ressources_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_ressources.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_ressources");
        }
...
/************************************************************************************************
 *     68992 characters generated by Talend Open Studio for Data Integration 
