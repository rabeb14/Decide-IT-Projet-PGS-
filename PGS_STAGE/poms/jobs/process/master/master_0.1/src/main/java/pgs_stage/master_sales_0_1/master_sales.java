...
package pgs_stage.master_sales_0_1;
...
/**
 * Job: master_sales Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_sales implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_sales";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_sales.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pgs_stage.dim_orders_0_1.DIM_ORDERS childJob_tRunJob_1 = new pgs_stage.dim_orders_0_1.DIM_ORDERS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		pgs_stage.dim_order_recipe_0_1.DIM_ORDER_RECIPE childJob_tRunJob_2 = new pgs_stage.dim_order_recipe_0_1.DIM_ORDER_RECIPE();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pgs_stage.dim_api_0_1.DIM_API childJob_tRunJob_3 = new pgs_stage.dim_api_0_1.DIM_API();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		pgs_stage.dim_customer_0_1.DIM_CUSTOMER childJob_tRunJob_4 = new pgs_stage.dim_customer_0_1.DIM_CUSTOMER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		pgs_stage.dim_driver_0_1.DIM_DRIVER childJob_tRunJob_5 = new pgs_stage.dim_driver_0_1.DIM_DRIVER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		pgs_stage.dim_supplier_product_0_1.DIM_SUPPLIER_PRODUCT childJob_tRunJob_6 = new pgs_stage.dim_supplier_product_0_1.DIM_SUPPLIER_PRODUCT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		pgs_stage.dim_trailer_0_1.DIM_TRAILER childJob_tRunJob_7 = new pgs_stage.dim_trailer_0_1.DIM_TRAILER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		pgs_stage.dim_order_trailer_0_1.DIM_ORDER_TRAILER childJob_tRunJob_8 = new pgs_stage.dim_order_trailer_0_1.DIM_ORDER_TRAILER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		pgs_stage.fact_sales_sam_0_1.FACT_SALES_SAM childJob_tRunJob_9 = new pgs_stage.fact_sales_sam_0_1.FACT_SALES_SAM();
	    // pass DataSources
 ...
 */
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7Q+N/DAlbhA3+EJ3j8SgB/yUSYp7pYah29ieLYWcHHgsHU8IaxOyUBhFYWe7azU=");
 ...
 */
    ...
    public static void main(String[] args){
        final master_sales master_salesClass = new master_sales();

        int exitCode = master_salesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_sales.class.getClassLoader().getResourceAsStream("pgs_stage/master_sales_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_sales.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_sales");
        }
...
/************************************************************************************************
 *     97382 characters generated by Talend Open Studio for Data Integration 
