...
package pgs_stage.fact_test_0_1;
 ...
 * @status
 */
public class fact_test implements TalendJob {
	...
	private final String jobName = "fact_test";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fact_test.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_PGS_STAGE_fact_test = new byte[0];
		static byte[] commonByteArray_PGS_STAGE_fact_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PGS_STAGE_fact_test.length) {
					if (length < 1024 && commonByteArray_PGS_STAGE_fact_test.length == 0) {
						commonByteArray_PGS_STAGE_fact_test = new byte[1024];
					} else {
						commonByteArray_PGS_STAGE_fact_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PGS_STAGE_fact_test, 0, length);
				strReturn = new String(commonByteArray_PGS_STAGE_fact_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PGS_STAGE_fact_test, 0, length);
				strReturn = new String(commonByteArray_PGS_STAGE_fact_test, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PGS_STAGE_fact_test) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:xORN6PUyHe39IG69GUOSc14QG/W2CshL0DpWSVvx5CepTUCOaMY=");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "FOLIO";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "FOLIO";
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute(
							"CREATE TABLE [" + tableName_tDBOutput_1 + "]([FOLIO_NUMBER] VARCHAR(8)   not null )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([FOLIO_NUMBER]) VALUES (?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Zp3tDX9q66CI0XXR1PJHbtUxRG0oDQMbhH/HzmIq8OKJlc81ulM=");
				...
				String dbquery_tDBInput_5 = "SELECT dbo.DIM_GAIN_LOSS_HISTORY.PK_GAIN_LOSS_HISTORY,\n		dbo.DIM_GAIN_LOSS_HISTORY.TERMINAL_PRODUCT_NUMBER,\n		dbo.DIM_G"
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							row1.PK_GAIN_LOSS_HISTORY = 0;
						} else {

							row1.PK_GAIN_LOSS_HISTORY = rs_tDBInput_5.getInt(1);
						...
						if (colQtyInRs_tDBInput_5 < 2) {
							...
							row1.TERMINAL_PRODUCT_NUMBER = rs_tDBInput_5.getInt(2);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 3) {
							...
							row1.DATE = mssqlGTU_tDBInput_5.getDate(rsmd_tDBInput_5, rs_tDBInput_5, 3);
						...
						if (colQtyInRs_tDBInput_5 < 4) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row1.FOLIO_NUMBER = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row1.FOLIO_NUMBER = tmpContent_tDBInput_5;
								}
							} else {
								row1.FOLIO_NUMBER = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 5) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row1.TANK_CODE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row1.TANK_CODE = tmpContent_tDBInput_5;
								}
							} else {
								row1.TANK_CODE = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 6) {
							...
							row1.GAIN_LOSS_ID = rs_tDBInput_5.getInt(6);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 7) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row1.PRODUCT_GROUP_CODE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row1.PRODUCT_GROUP_CODE = tmpContent_tDBInput_5;
								}
							} else {
								row1.PRODUCT_GROUP_CODE = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 8) {
							...
							row1.OPENING_CALCULATION_POINT = rs_tDBInput_5.getInt(8);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 9) {
							...
							row1.CLOSING_CALCULATION_POINT = rs_tDBInput_5.getInt(9);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 10) {
							...
							row1.OPENING_PRODUCT_STRAP_TYPE = rs_tDBInput_5.getInt(10);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 11) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row1.OPENING_API_CODE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row1.OPENING_API_CODE = tmpContent_tDBInput_5;
								}
							} else {
								row1.OPENING_API_CODE = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 12) {
							...
							row1.CLOSING_PRODUCT_STRAP_TYPE = rs_tDBInput_5.getInt(12);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 13) {
							...
							if (tmpContent_tDBInput_5 != null) {
								if (talendToDBList_tDBInput_5.contains(
									...
									row1.CLOSING_API_CODE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
								} else {
									row1.CLOSING_API_CODE = tmpContent_tDBInput_5;
								}
							} else {
								row1.CLOSING_API_CODE = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 14) {
							...
							row1.OPENING_TEMPERATURE_ORIGIN = rs_tDBInput_5.getInt(14);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 15) {
							...
							row1.CLOSING_TEMPERATURE_ORIGIN = rs_tDBInput_5.getInt(15);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 16) {
							...
							row1.INVENTORY_QUANTITY_TYPE = rs_tDBInput_5.getInt(16);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 17) {
							...
							row1.COMPARTMENT_VISIT_NUMBER = rs_tDBInput_5.getInt(17);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
...
// Start of branch "out1"
								if (out1 != null) {
									...
									if (out1.FOLIO_NUMBER == null) {
										...
										finder_tUniqRow_1.FOLIO_NUMBER = out1.FOLIO_NUMBER.toLowerCase();
									}
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										if (out1.FOLIO_NUMBER == null) {
											...
											new_tUniqRow_1.FOLIO_NUMBER = out1.FOLIO_NUMBER.toLowerCase();
										}
										...
										row4.FOLIO_NUMBER = out1.FOLIO_NUMBER;
...
// Start of branch "row4"
									if (row4 != null) {
										...
										if (row4.FOLIO_NUMBER == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(1, row4.FOLIO_NUMBER);
										}
...
// ###############################      
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_1 - inputs:(after_tDBInput_5) outputs:(row2,row2) |
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:/kBFo1JeXr8yd/S8VkmMeiEwILJQWpN71DBcJT2Uc2sXJEk18O4=");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							row2.PK_BOOK_INVENTORY_HISTORY = 0;
						} else {

							row2.PK_BOOK_INVENTORY_HISTORY = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row2.FOLIO_NUMBER = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row2.FOLIO_NUMBER = tmpContent_tDBInput_1;
								}
							} else {
								row2.FOLIO_NUMBER = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							row2.BOOK_INVENTORY_ID = 0;
						} else {

							row2.BOOK_INVENTORY_ID = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row2.SI_SUPPLIER_NUMBER = null;
						} else {

							row2.SI_SUPPLIER_NUMBER = rs_tDBInput_1.getInt(5);
							if (rs_tDBInput_1.wasNull()) {
								row2.SI_SUPPLIER_NUMBER = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							row2.SI_TERMINAL_PRODUCT_NUMBER = null;
						} else {

							row2.SI_TERMINAL_PRODUCT_NUMBER = rs_tDBInput_1.getInt(6);
							if (rs_tDBInput_1.wasNull()) {
								row2.SI_TERMINAL_PRODUCT_NUMBER = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row2.INVENTORY_QUANTITY_TYPE = rs_tDBInput_1.getInt(7);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						row2_HashRow.PK_BOOK_INVENTORY_HISTORY = row2.PK_BOOK_INVENTORY_HISTORY;

						row2_HashRow.FOLIO_NUMBER = row2.FOLIO_NUMBER;

						row2_HashRow.DATE = row2.DATE;

						row2_HashRow.BOOK_INVENTORY_ID = row2.BOOK_INVENTORY_ID;

						row2_HashRow.SI_SUPPLIER_NUMBER = row2.SI_SUPPLIER_NUMBER;

						row2_HashRow.SI_TERMINAL_PRODUCT_NUMBER = row2.SI_TERMINAL_PRODUCT_NUMBER;
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_3 - inputs:(after_tDBInput_5) outputs:(row3,row3) |
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:mB2/qPQtkEo0eqkCaRpjEs/b0rDSWKBso/nNpzVk9oLnD96QBm8=");
	...
	public static void main(String[] args) {
		final fact_test fact_testClass = new fact_test();

		int exitCode = fact_testClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fact_test.class.getClassLoader()
					.getResourceAsStream("pgs_stage/fact_test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fact_test.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_test");
		}
...
/************************************************************************************************
 * 158588 characters generated by Talend Open Studio for Data Integration on the
 * 23 juillet 2024 à 09:43:13 GMT+01:00
 ************************************************************************************************/