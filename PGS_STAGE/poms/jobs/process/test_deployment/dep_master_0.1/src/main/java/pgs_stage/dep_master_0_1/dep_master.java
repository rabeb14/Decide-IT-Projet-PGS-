...
package pgs_stage.dep_master_0_1;
...
/**
 * Job: dep_master Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dep_master implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dep_master";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dep_master.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PGS_STAGE_dep_master = new byte[0];
    static byte[] commonByteArray_PGS_STAGE_dep_master = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PGS_STAGE_dep_master) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pgs_stage.dep_0_1.dep childJob_tRunJob_1 = new pgs_stage.dep_0_1.dep();
	    // pass DataSources
 ...
 */
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:urn1yvSaE69Uj8v/F8YAk8L4KOP0jseAMXml4M2HP4yKD/ijptoZbDTnQQt5cjo=");
 ...
 */
    ...
    public static void main(String[] args){
        final dep_master dep_masterClass = new dep_master();

        int exitCode = dep_masterClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dep_master.class.getClassLoader().getResourceAsStream("pgs_stage/dep_master_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dep_master.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dep_master");
        }
...
/************************************************************************************************
 *     40899 characters generated by Talend Open Studio for Data Integration 
