...
package pgs_stage.master_ressources_copy_0_1;
...
/**
 * Job: master_ressources_Copy Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class master_ressources_Copy implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "master_ressources_Copy";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				master_ressources_Copy.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(master_ressources_Copy.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pgs_stage.dim_api_copy_0_1.DIM_API_Copy childJob_tRunJob_1 = new pgs_stage.dim_api_copy_0_1.DIM_API_Copy();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		pgs_stage.dim_book_inventory_history_copy_0_1.DIM_BOOK_INVENTORY_HISTORY_Copy childJob_tRunJob_2 = new pgs_stage.dim_book_inventory_history_copy_0_1.DIM_BOOK_INVENTORY_HISTORY_Copy();
	    // pass DataSources
 ...
 */
    ...
    String subject_tSendMail_1 = ("Deployment test");
	...
	final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3I7DhA0UZ3WhbzfiOPSiGuEjGAbsbqV5W5lOfPPrk6LYJSdnfgPvb06Cpuj7iTU=");
		...
		msg_tSendMail_1.setFrom(new javax.mail.internet.InternetAddress(from_tSendMail_1, "Deploymen"));
 ...
 */
    ...
    public static void main(String[] args){
        final master_ressources_Copy master_ressources_CopyClass = new master_ressources_Copy();

        int exitCode = master_ressources_CopyClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = master_ressources_Copy.class.getClassLoader().getResourceAsStream("pgs_stage/master_ressources_copy_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = master_ressources_Copy.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_ressources_Copy");
        }
...
/************************************************************************************************
 *     47702 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 août 2024 à 14:34:39 GMT+01:00
 ************************************************************************************************/