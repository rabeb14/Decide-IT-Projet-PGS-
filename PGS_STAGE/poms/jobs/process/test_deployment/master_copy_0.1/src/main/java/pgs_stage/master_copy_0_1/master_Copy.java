...
package pgs_stage.master_copy_0_1;
 ...
 * @status
 */
public class master_Copy implements TalendJob {
	...
	private final String jobName = "master_Copy";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(master_Copy.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pgs_stage.master_ressources_copy_0_1.master_ressources_Copy childJob_tRunJob_1 = new pgs_stage.master_ressources_copy_0_1.master_ressources_Copy();
				// pass DataSources
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String subject_tSendMail_1 = ("Deployment test master");
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:O6DoXHRhRr+9vG/ZY0xoEPr5n6YiO33g6GPncRNoIBXaf0NaXmSPPHIrrjO96o0=");

									return new javax.mail.PasswordAuthentication("dhiaajmi7@gmail.com",
	...
	public static void main(String[] args) {
		final master_Copy master_CopyClass = new master_Copy();

		int exitCode = master_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = master_Copy.class.getClassLoader()
					.getResourceAsStream("pgs_stage/master_copy_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = master_Copy.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : master_Copy");
		}
...
/************************************************************************************************
 * 40398 characters generated by Talend Open Studio for Data Integration on the
 * 3 août 2024 à 14:34:39 GMT+01:00
 ************************************************************************************************/